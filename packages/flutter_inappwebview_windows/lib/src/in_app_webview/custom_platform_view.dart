    ...
    _eventStreamSubscription =
      ...
      switch (map['type']) {
        case 'cursorChanged':
          ...
          break;
        case 'focusChanged':
          _focusStreamController.add(map['value'] as bool);
          break;
      }
    });
            ...
            child: _controller.value.isInitialized
                ? Listener(
                    ...
                    onPointerDown: (ev) {
                      ...
                      // Don't call requestFocus() here - it fights with WebView2's
                      // native focus handling and causes input fields to lose focus.
                      // Let WebView2 handle focus through the mouse events.
                      // Flutter focus will be requested when WebView2 reports GotFocus.
